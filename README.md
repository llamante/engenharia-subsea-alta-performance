...
*   **`pdf/especificacoes-frota-rovs.pdf`**: Relatório técnico consolidado em alta definição, contendo gráficos comparativos e análises detalhadas da mecânica, potência e aplicação da frota de ROVs.
