...
1.  **Lâminas Técnicas Corporativas (https://github.com/user-attachments/files/30795227/TechnipFMC_Subsea_Mastery.pptx)
):** Documento oficial com especificações físicas, financeiras e detalhes de engenharia de toda a frota robótica.
